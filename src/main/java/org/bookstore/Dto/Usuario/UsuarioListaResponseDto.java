...
// DTO para representar una respuesta de lista de usuarios
public class UsuarioListaResponseDto {
    ...
    public UsuarioListaResponseDto(Long id, String nombre, String apellido, String email, String num_celular, List<RolResponseDto> listaRoles) {
        this.id = id;
        this.nombre = nombre;
